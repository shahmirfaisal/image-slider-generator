...
export const EndpointTable = () => {
  return (
    <TableContainer className={classes.tableContainer} component={Paper} sx={{ mb: 5,  }}>
      <Table>
        <TableHead>
          <TableRow>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell>For creating a single slider.</TableCell>
          </TableRow>
           ...
           <TableRow>
            ...
            <TableCell>For creating multiple sliders.</TableCell>
          </TableRow>
        </TableBody>
      </Table>
    </TableContainer>
      ...
      <Table>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell>Array</TableCell>
            <TableCell>[]</TableCell>
            <TableCell>Array of images. Use string.</TableCell>
          </TableRow>
          <TableRow>
            <TableCell>options</TableCell>
            <TableCell>Object</TableCell>
            <TableCell></TableCell>
            <TableCell>Customize the slider.</TableCell>
          </TableRow>
        </TableBody>
      </Table>
    </TableContainer>
